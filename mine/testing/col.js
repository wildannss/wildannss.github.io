...
for(i=1; i<=1; i++){
    iimSet("loop",i);
    var run = iimGetErrorText(iimPlay("loginNoUser"));
...
//     console.log('Working');
//     document
//         .querySelector('#cell-8uQ12Gz6ZzCb>DIV:nth-of-type(2)>DIV:nth-of-type(4)>COLAB-RUN-BUTTON>DIV>DIV:nth-of-type(2)>IRON-ICON')
//         .click();
// }
...
// setInterval(ClickConnect, 60000)
    ...
    // setInterval(function(){ document.querySelector('#cell-8uQ12Gz6ZzCb>DIV:nth-of-type(2)>DIV:nth-of-type(4)>COLAB-RUN-BUTTON>DIV>DIV:nth-of-type(2)>IRON-ICON').click() }, 300000);
